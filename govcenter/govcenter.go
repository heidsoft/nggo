...
func GetEnvString(v string, def string) string {
	fmt.Println("系统环境变量key", v)
	r := os.Getenv(v)
	fmt.Println("系统环境变量value", r)
	if r == "" {
		return def
	}
...
func GetEnvBool(v string, def bool) bool {
	fmt.Println("安装系统环境信息key", v)
	r := os.Getenv(v)
	fmt.Println("安全系统环境信息value", r)
	if r == "" {
		return def
	}
...
var urlFlag = flag.String("url", GetEnvString(envURL, "https://administrator@demo.cc:Admin@123@10.0.1.33/sdk"), urlDescription)
